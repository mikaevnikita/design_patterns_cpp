 ...
 * Применяется для последовательного конструирования сложных объектов,
 * управляет конструированием Director
*/
...
public:
    ...
    void ShowPizza()
    {
        std::cout << "Dough: " << dough << " Sauce: "
                  << sauce << " Topping: " << topping << std::endl;
    }
};
